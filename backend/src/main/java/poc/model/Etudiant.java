...
public class Etudiant {
    ...
    public String getMatriculeCsv() { return matriculeCsv; }
    public void setMatriculeCsv(String matriculeCsv) { this.matriculeCsv = matriculeCsv; }
    ...
    public Lycee getLycee() { return lycee; }
    public void setLycee(Lycee lycee) { this.lycee = lycee; }
